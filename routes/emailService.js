...
if (!SENDGRID_API_KEY) {
    console.error('❌ ERROR CRÍTICO: SENDGRID_API_KEY no está configurada en .env');
    console.error('📌 Las notificaciones por correo NO funcionarán hasta que configures una API Key válida.');
} else {
